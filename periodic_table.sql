...
INSERT INTO public.properties VALUES (5, 11, 2075, 4000, 4);
...
--
-- Name: properties for_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT for_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties for_key3; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT for_key3 FOREIGN KEY (type_id) REFERENCES public.types(type_id);
